...
# Array to store system calls of all the system call trace files
data = []
...
############## Fit data
''' 
Update n-gram value accordingly in TfidfVectorizer parameter
'''
print("Fitting data...")
tfidf_vectorizer = TfidfVectorizer(norm=None, ngram_range=(3,3))
new_term_freq_matrix = tfidf_vectorizer.fit_transform(data)
print(tfidf_vectorizer.vocabulary_)
print("Writing training data to txt file...")
with open("3gramterms.txt", "w", newline="") as f:
    writer = csv.writer(f)
    writer.writerows(tfidf_vectorizer.vocabulary_)
...
'''
number of componenets are taken as 3%, 6%, 9%, 12% and 15% of the total generated
'''
print("Performing dimensionality reduction...")
svd = TruncatedSVD(n_components=550, n_iter=7, random_state=42)
